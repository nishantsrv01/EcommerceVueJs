<template>
  <div>
    <header class="bg-white black-80 tc pt4 avenir">
      ...
      <h2 class="mt2 mb0 f6 fw4 ttc tracked i">
        Your satisfaction is our utmost pleasure...
      </h2>
      <nav class="bt bb tc mw7 center mt4 flex justify-between flex-wrap">
        ...
        <a
          ...
          v-if="$auth.isAuthenticated"
        >
          <img :src="$auth.user.picture" class="br-100 w1 h1" alt="" />
          <span id="qsLogoutBtn" href="#" @click.prevent="logout">
            Log out
          </span>
        </a>
      </nav>
